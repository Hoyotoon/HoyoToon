...
namespace HoyoToon.EditorTools.ManagerUI.Utilities
{
	internal static class HoyoToonManagerModelCache
	{
		...
		public static string ResolveGameDisplayName(string gameKey)
		{
			...
			if (HoyoToonResourceConfig.Games != null && HoyoToonResourceConfig.Games.TryGetValue(gameKey, out var gameConfig))
			{
