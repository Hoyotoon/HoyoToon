...
namespace HoyoToon.Runtime.Rendering.HSR
{
    public class CharacterSelfShadowAtlas : ScriptableRendererFeature
    {
        ...
        class CharacterSelfShadowAtlasPass : ScriptableRenderPass
        {
            ...
            internal static readonly ShaderTagId k_LightModeTag = new ShaderTagId("LightMode");
            ...
            {
                return HsrRendererMaterialQueryUtility.HasMaterialTagOrShaderPassOrNamedPass(
                    material,
                    k_LightModeTagName,
                    k_LightModeTag,
                    k_CustomForwardPassName,
