Shader "HoyoToon/Honkai Star Rail/Character/Base"
{
    Properties
    {
        ...
        [Sub(SpecularRoughness)] _SpecularRoughness7 ("Roughness 7", Range(0, 1)) = 0
        ...
        [Advanced][Sub(SpecularGroup)] _ES_SPIntensity ("intensity", Float) = 0.1
        ...
        [Sub(RimGroup)] _RimWidth ("RimWidth", Float) = 0.5
