Shader "HoyoToon/Genshin Impact/Legacy/Character/Monster_Asmoday_Cloak"
{
    Properties
    {
        ...
        [Header(ASE Properties)] _HitColorScaler ("HitColorScaler", Float) = 6
    ...
    SubShader
    {
        ...
        Pass
        {
            ...
            #pragma shader_feature_local TOON_SPECULAR_ON
