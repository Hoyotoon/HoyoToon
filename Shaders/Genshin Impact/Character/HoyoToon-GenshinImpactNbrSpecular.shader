Shader "HoyoToon/Genshin Impact/Character/NbrSpecular"
{
    Properties
    {
        ...
        [Main(CharacterNbrSpecular, ENABLE_CHARACTER_NBRSPECULAR_ON, off, on)] _UseCharacterNbrSpecular ("CharacterNbrSpecular", Float) = 0
        [Sub(CharacterNbrSpecular)] _NbrlightScale ("Nbr lightScale", Range(0, 5)) = 1
        [Sub(CharacterNbrSpecular)] [HDR] _NbrMainSpecularColor ("NbrMain SpecularColor", Color) = (0,0,0,1)
        [Sub(CharacterNbrSpecular)] _NbrSpecularMetal ("NbrSpecular Metal", Range(0, 1)) = 0
        [Sub(CharacterNbrSpecular)] _NbrSpecularRoughness ("NbrSpecular Roughness", Range(0, 1)) = 0.5
        [Sub(CharacterNbrSpecular)] _NbrSpecularScale ("NbrSpecular Scale", Range(0, 1)) = 0.5
        [Sub(CharacterNbrSpecular)] _NbrSpecularRefScale ("NbrSpecular RefScale", Range(0, 1)) = 0.5
        [Sub(CharacterNbrSpecular)] _NbrSpecularParallaxScale ("NbrSpecular ParallaxScale", Range(0, 1)) = 0
        [Sub(CharacterNbrSpecular)] _NbrSpecularDirScale ("Nbr SpecularDirScale", Range(0, 1)) = 0
        [Sub(CharacterNbrSpecular)] _NbrSpecularIblColor ("NbrSpecular IblColor", Color) = (1,1,1,1)
        [Sub(CharacterNbrSpecular)] _NbrSpecularIbl ("NbrSpecular Ibl", Cube) = "_Skybox" { }
        [Sub(CharacterNbrSpecular)] _NbrSpecularIblScale ("NbrSpecular IblScale", Range(0, 1)) = 0.5
        [Sub(CharacterNbrSpecular)] _NbrSpecularIblBlur ("NbrSpecular IblBlur", Range(0, 1)) = 0.5
        [Sub(CharacterNbrSpecular)] _NbrSpecularColor ("NbrSpecular Color", Color) = (1,1,1,1)
        [Sub(CharacterNbrSpecular)] _NbrSpecularRange ("NbrSpecular Range", Range(0.1, 10)) = 1
        [Sub(CharacterNbrSpecular)] _NbrSpecularIntensity ("NbrSpecular Intensity", Range(0, 1)) = 0
        [SubToggle(CharacterNbrSpecular)] _UseMatCapReflection ("Use MatCapReflection?", Float) = 0
        [Sub(CharacterNbrSpecular)] [HDR] _MatCapSpecularRefColor ("MatCap SpecularRefColor", Color) = (1,1,1,1)
        [Sub(CharacterNbrSpecular)] _MatCapSpecularRefScale ("MatCap SpecularRefScale", Range(0, 1)) = 0
        [Sub(CharacterNbrSpecular)] _MatCapSpecularRefTiling ("MatCap SpecularRefTiling", Range(0, 5)) = 1
        [Sub(CharacterNbrSpecular)] [HDR] _NbrParallaxColor ("Nbr ParallaxColor", Color) = (0,0,0,1)
        [Sub(CharacterNbrSpecular)] _NbrParallaxTex ("Nbr ParallaxTex", 2D) = "black" { }
        [Sub(CharacterNbrSpecular)] _NbrParallaxTilingOffset ("Nbr ParallaxTilingOffset", Vector) = (1,1,0,0)
        [Sub(CharacterNbrSpecular)] _NbrParallaxDepth ("Nbr ParallaxDepth", Range(-10, 10)) = 0
        [Sub(CharacterNbrSpecular)] _NbrParallaxScale ("Nbr ParallaxScale", Range(0, 5)) = 0
        [Sub(CharacterNbrSpecular)] [HDR] _NbrNoiseColor ("Nbr NoiseColor", Color) = (0,0,0,1)
        [Sub(CharacterNbrSpecular)] _NbrNoiseTilingOffset ("Nbr NoiseTilingOffset", Vector) = (1,1,0,0)
        [Sub(CharacterNbrSpecular)] _NbrNoiseScale ("Nbr NoiseScale", Range(0, 5)) = 0
        [Sub(CharacterNbrSpecular)] _NbrCurvatureScale ("Nbr CurvatureScale", Range(0, 1)) = 0
        [Sub(CharacterNbrSpecular)] [HDR] _NbrReflectionPlaneColor ("Nbr ReflectionPlaneColor", Color) = (0,0,0,1)
        [Sub(CharacterNbrSpecular)] _NbrReflectionPlaneRange ("Nbr ReflectionPlaneRange", Range(0, 20)) = 0
        [Sub(CharacterNbrSpecular)] _NbrReflectionPlaneScale ("NbrcReflectionPlaneScale", Range(0, 5)) = 0

        [Main(MetalMaterial, METAL_MAT, off, on)] _MetalMaterial ("MetalMaterial", Float) = 0
    ...
    SubShader
    {
        ...
        Pass
        {
            ...
            #pragma shader_feature_local ENABLE_CHARACTER_NBRSPECULAR_ON
