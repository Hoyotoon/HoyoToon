Shader "HoyoToon/Genshin Impact/Character/StockingsNew"
{
    Properties
    {
        ...
        [Main(CharacterMainTex, _, off, off)] _CharacterMainTex ("Main Texture", Float) = 0
        ...
        [Tex(CharacterMainTex)] [NoScaleOffset] _EyeMask ("Eye Mask (R)", 2D) = "white" { }
        [SubToggle(CharacterMainTex)] _EnableEyeMaskDraw ("Enable Eye Mask Draw", float) = 0
        [SubToggle(CharacterMainTex)] _DrawAlphaClipEye ("Enable Eye Mask Draw", float) = 0
        
        [Main(MaterialMasks, MATERIAL_MASK)] _UseMaterialMasksTex ("MaterialMasks", Float) = 0
        [Tex(MaterialMasks)] _MaterialMasksTex ("MaterialMasks", 2D) = "black" { }
        [Main(LightMap, TOON_LIGHTMAP_ON)] _UseToonLightMap ("LightMap", Float) = 0
        ...
        [Main(BumpMap, BUMP_TEXTURELINE_MAP)] _UseBumpMap ("BumpMap", Float) = 0
        ...
        [Main(ShadowRamp, SHADOW_RAMP_ON)] _UseShadowRamp ("ShadowRamp", Float) = 0
        ...
        [Sub(CharacterSpecular)] [HDR] _SpecularColor ("Specular Color 1", Color) = (1,1,1,1)
        [Sub(CharacterSpecular)] _SpecOpacity ("Specular Opacity 1", Range(0, 1)) = 0
        [Main(Stockingss, ENABLE_CHARACTER_STOCKINGS_ON)] _UseCharacterStockings ("Stockingss", Float) = 0
        [Sub(Stockingss)] _StockingsSpecularColor ("Stockings Specular Color", Color) = (1,1,1,1)
        [Sub(Stockingss)] _StockingsSpecularShift ("Stockings Specualr Shift", Range(-2, 1)) = -0.5
        [Sub(Stockingss)] _StockingsSpecularRange ("Stockings Specualr Range", Range(1, 200)) = 50
        [Sub(Stockingss)] _StockingsSpecularScale ("Stockings Specualr Scale", Range(0, 1)) = 0
        [Sub(Stockingss)] _StockingsSpecularSharpe ("Stockings Specualr Sharpe", Range(0.501, 1)) = 1
        [Sub(Stockingss)] _StockingsSpecularDetailColor ("Stockings DetailSpecular Color", Color) = (1,1,1,1)
        [Sub(Stockingss)] _StockingsSpecularDetailRange ("Stockings DetailSpecular Range", Range(0.01, 200)) = 50
        [Sub(Stockingss)] _StockingsSpecularDetailScale ("Stockings DetailSpecular Scale", Range(0, 1)) = 0
        [Sub(Stockingss)] _StockingsSpecularDetailSharpe ("Stockings Specualr Sharpe", Range(0.501, 1)) = 1
        [Sub(Stockingss)] _StockingsDetailTex ("Stockings DetailTex", 2D) = "black" { }
        [Sub(Stockingss)] _StockingsDetailTilingNear ("Stockings DetailTilingNear", Float) = 1
        [Sub(Stockingss)] _StockingsDetailScale ("Stockings DetailScale", Range(0, 5)) = 1
        [Sub(Stockingss)] _StockingsLightColor ("Stockings LightColor", Color) = (1,1,1,1)
        [Color(Stockingss)] _StockingsLightDarkColor ("Stockings Dark LightColor", Color) = (1,1,1,1)
        [Sub(Stockingss)] _StockingsLightRange ("Stockings LightRange", Range(1, 20)) = 1
        [Sub(Stockingss)] _StockingsLightScale ("Stockings LightScale", Range(1, 5)) = 1
        [Sub(Stockingss)] _StockingsLightScaleInShadow ("Stockings LightScaleInShadow", Range(0, 1)) = 0.5
        [SubGroup(Stockingss, StockAmbient)] _dummyStockAmbient ("stocking ambient", float) = 0
        [Sub(StockAmbient)] _UseStockingAmbientColor ("Use Ambient Color Stocking", Float) = 0
        [Sub(StockAmbient)] _StockingAmbientColorStrength ("Stocking Ambient Color Strength", Range(0, 1)) = 0
        [SubGroup(Stockingss, StockGradient)] _dummyGradient ("Stocking Gradient", float) = 0
        [SubToggle(StockGradient)] _UseGradientStocking ("Use Gradient Stocking", Float) = 0
        [SubEnum(StockGradient, up,0,down,1,upAndDown,2,leftAndRight,3,Right,4)] _StockingsGradientTypeChoose ("Stockings Gradient Type Choose", Float) = 0
        [Sub(StockGradient)] _StockingsGradientLength ("Stockings Gradient Length", Range(1, 20)) = 1
        [Sub(StockGradient)] _StockingsGradientStrength ("Stockings Gradient Strength", Range(0, 1)) = 0.5
        [Sub(StockGradient)] _StockingsGradientLightColor (" Stockings Gradient Light Color", Color) = (1,1,1,1)
        [Sub(StockGradient)] _StockingsGradientDarkColor ("Stockings Gradient Dark Color", Color) = (1,1,1,1)
        [SubGroup(StockGradient, StockingRamp)] _dummyRamp ("Stocking Ramp", float) = 0 
        [SubToggle(StockingRamp)] _UseGradientStockingRampColor ("Use Gradient Stocking RampColor", Float) = 0
        // [SubMHYPackedGradientChild(Stockingss,  _ShadowRampStockingGradientColor ,  _UseGradientStockingRampColor)] _StockingsShadowRamp ("Stockings Shadow Ramp", 2D) = "grey" { }
        [Tex(StockingRamp)] _StockingsShadowRamp ("Stockings Shadow Ramp", 2D) = "grey" { }
        [Sub(Stockingss)] _StockingsShadowColor ("Stockings ShadowColor", Color) = (1,1,1,1)
        [Sub(Stockingss)] _StockingsShadowRange ("Stockings ShadowRange", Range(1, 20)) = 1
        [SubGroup(Stockingss, SecondFresnel)] _dummyFresnel ("Stocking Fresnel", float) =0
        [SubToggle(SecondFresnel)] _UseSecondFresnel ("Use Gradient Stocking RampColor", Float) = 0
        [Sub(SecondFresnel)] _StockingsSecondShadowColor ("Stockings ShadowColor2", Color) = (1,1,1,1)
        [Sub(SecondFresnel)] _StockingsSecondShadowRange ("Stockings ShadowRange", Range(0.01, 20)) = 0.5
        [Sub(SecondFresnel)] _StockingsSecondShadowSoft ("Stockings ShadowRange2", Range(0.01, 1)) = 0.01
        [Sub(Stockingss)] _StockingsSpecularDistance ("Stockings SpecularDistance", Float) = 3
        [Sub(Stockingss)] _StockingsSpecularFade ("Stockings SpecularFade", Float) = 1
        [Sub(Stockingss)] _StockingsDetailPattenColor ("Stockings DetailPattenColor", Color) = (0,0,0,1)
        [Sub(Stockingss)] _StockingsDetailPattenScale ("Stockings DetailPattenScale", Range(0, 1)) = 0
        [Sub(Stockingss)] _StockingsDetailPattenTiling ("Stockings DetailPattenTiling", Float) = 10
        [Main(Shining, ENABLE_CHARACTER_SHINING_ON)] _UseCharacterShining ("Shining", Float) = 0
        [SubToggle(Shining)] _ShiningNotUseMask ("Use Mask for Shining", Float) = 0
        [Sub(Shining)] _ShiningSizeNear (" ShiningNearSizeScale", Range(0, 2)) = 1
        [Sub(Shining)] _ShiningSizeFar (" ShiningFarSizeScale", Range(0, 2)) = 1
        [Sub(Shining)] _ShiningMaxDistance ("ShiningMaxDistance", Range(0, 20)) = 1
        [Sub(Shining)] _ShiningFarNearBlend (" ShiningFarAndNearBlend", Range(0, 1)) = 1
        [Sub(Shining)] [HDR] _ShiningColor (" ShiningColor", Color) = (1,1,1,1)
        [Sub(Shining)] _ShiningTiling (" ShiningTiling", Float) = 40
        [Sub(Shining)] _ShiningSize (" ShiningSize", Range(0, 2)) = 0.05
        [Sub(Shining)] _ShiningFrequencncy (" ShiningFrequencncy", Range(0, 10)) = 0
        [Sub(Shining)] _ShiningDensity (" ShiningDensity", Range(0, 1)) = 0.3
        [Sub(Shining)] _ShiningIntensity (" ShiningIntensity", Range(0, 10)) = 3
        [Sub(Shining)] _ShiningColorBlend (" ShiningColorBlend", Range(0, 1)) = 0
        [Main(MetalMaterial, METAL_MAT)] _MetalMaterial ("MetalMaterial", Float) = 0
        ...
        [Sub(MetalMaterial)] [HDR] _MTMapLightColor ("Metal Map Light Color", Color) = (1,1,1,1)
        [Sub(MetalMaterial)] [HDR] _MTMapDarkColor ("Metal Map Dark Color", Color) = (0,0,0,0)
        ...
        [Sub(MetalMaterial)] [HDR] _MTSpecularColor ("Metal Specular Color", Color) = (1,1,1,1)
        ...
        [Sub(MetalMaterial)] [HDR] _MTSharpLayerColor ("Sharp High Light Color", Color) = (1,1,1,1)
        ...
        [Sub(CharacterEmission)] [HDR] _EmissionColor_MHY1 ("Emission Color 1", Color) = (1,1,1,1)
        ...
        [Sub(CharacterEmission)] [HDR] _EmissionBloomColor ("Outline EmissionColor", Color) = (1,1,1,1)
        ...
        // [Sub(TextureLine)] [HDR] _TextureLineMultiplier ("TextureLine Multiplier", Color) = (1,1,1,1)
        ...
        [Sub(MaterialTwo)] [HDR] _EmissionColor_MHY2 ("Emission Color 2", Color) = (1,1,1,1)
        ...
        [Sub(MaterialTwo)] [HDR] _SpecularColor2 ("Specular Color 2", Color) = (1,1,1,1)
        [Sub(MaterialTwo)] [HDR] _CharacterCubeColor2 ("Character Cube Color 2", Color) = (0,0,0,0)
        ...
        [Sub(MaterialThree)] [HDR] _EmissionColor_MHY3 ("Emission Color 3", Color) = (1,1,1,1)
        ...
        [Sub(MaterialThree)] [HDR] _SpecularColor3 ("Specular Color 3", Color) = (1,1,1,1)
        [Sub(MaterialThree)] [HDR] _CharacterCubeColor3 ("Character Cube Color 3", Color) = (0,0,0,0)
        ...
        [Sub(MaterialFour)] [HDR] _EmissionColor_MHY4 ("Emission Color 4", Color) = (1,1,1,1)
        ...
        [Sub(MaterialFour)] [HDR] _SpecularColor4 ("Specular Color 4", Color) = (1,1,1,1)
        [Sub(MaterialFour)] [HDR] _CharacterCubeColor4 ("Character Cube Color 4", Color) = (0,0,0,0)
        ...
        [Sub(MaterialFive)] [HDR] _EmissionColor_MHY5 ("Emission Color 5", Color) = (1,1,1,1)
        ...
        [Sub(MaterialFive)] [HDR] _SpecularColor5 ("Specular Color 5", Color) = (1,1,1,1)
        [Sub(MaterialFive)] [HDR] _CharacterCubeColor5 ("Character Cube Color 5", Color) = (0,0,0,0)
        ...
        [Sub(MainTextureTint)] [HDR] _MainTexTintColor ("Main Tex Tint Color", Color) = (1,1,1,1)
    ...
    SubShader
    {
        ...
        Pass
        {
            ...
            #pragma shader_feature_local ENABLE_CHARACTER_STOCKINGS_ON
            #pragma shader_feature_local ENABLE_CHARACTER_SHINING_ON
