Shader "HoyoToon/Genshin Impact/Character/BaseUber_FaceStencil"
{
    Properties
    {
    	...
    	[Header(Forward EyeMask Stencil)] [IntRange] _StencilMaskRef ("Stencil Ref", Range(0, 255)) = 165
        [IntRange] _StencilMaskWriteMask ("Stencil Write Mask", Range(0, 255)) = 225  
        [IntRange] _StencilMaskReadMask ("Stencil Read Mask", Range(0, 255)) = 255
    	...
    	[Header(Forward Shaded Stencil)] [IntRange] _StencilShadedRef ("Stencil Ref", Range(0, 255)) = 165
        [IntRange] _StencilShadedWriteMask ("Stencil Write Mask", Range(0, 255)) = 223  
        [IntRange] _StencilShadedReadMask ("Stencil Read Mask", Range(0, 255)) = 36
    	[Enum(UnityEngine.Rendering.CompareFunction)] _StencilShadedComp ("Stencil Comp", Float) = 8
        [Enum(UnityEngine.Rendering.StencilOp)] _StencilShadedOP ("Stencil Op", Float) = 2
