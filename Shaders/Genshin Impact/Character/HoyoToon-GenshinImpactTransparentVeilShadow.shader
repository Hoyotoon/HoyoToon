Shader "HoyoToon/Genshin Impact/Character/TransparentVeilShadow"
{
    Properties
    {
        ...
        [Main(CharacterShining, ENABLE_CHARACTER_SHINING_ON)] _UseCharacterShining ("CharacterShining", Float) = 0
        [SubToggle(CharacterShining)] _ShiningNotUseMask ("Not Use Mask for Shining", Float) = 0
        [Sub(CharacterShining)] _ShiningSizeNear ("ShiningNearSizeScale", Range(0, 2)) = 1
        [Sub(CharacterShining)] _ShiningSizeFar ("ShiningFarSizeScale", Range(0, 2)) = 1
        [Sub(CharacterShining)] _ShiningMaxDistance ("ShiningMaxDistance", Range(0, 20)) = 1
        [Sub(CharacterShining)] _ShiningFarNearBlend ("ShiningFarAndNearBlend", Range(0, 1)) = 1
        [Sub(CharacterShining)] [HDR] _ShiningColor ("ShiningColor", Color) = (1,1,1,1)
        [Sub(CharacterShining)] _ShiningTiling ("ShiningTiling", Float) = 40
        [Sub(CharacterShining)] _ShiningSize ("ShiningSize", Range(0, 2)) = 0.05
        [Sub(CharacterShining)] _ShiningFrequencncy ("ShiningFrequencncy", Range(0, 10)) = 0
        [Sub(CharacterShining)] _ShiningDensity ("ShiningDensity", Range(0, 1)) = 0.3
        [Sub(CharacterShining)] _ShiningIntensity ("ShiningIntensity", Range(0, 10)) = 3
        [Sub(CharacterShining)] _ShiningColorBlend ("ShiningColorBlend", Range(0, 1)) = 0
        ...
        [Main(Fresnel, ENABLE_FRESNEL_ON)] _EnableFresnel ("Fresnel", Float) = 0
        [Sub(Fresnel)] _FresnelPower ("Fresnel Power", Float) = 5
        [HideInInspector] _FresnelPower_State ("", Vector) = (0,0,0,0)
        [HideInInspector] _FresnelPower_Value1 ("", Vector) = (0,0,0,0)
        [HideInInspector] _FresnelPower_Value2 ("", Vector) = (0,0,0,0)
        [HideInInspector] _FresnelPower_LerpParam ("", Vector) = (0,0,0,0)
        [Sub(Fresnel)] _FresnelScale ("Fresnel Scale", Float) = 1
        [HideInInspector] _FresnelScale_State ("", Vector) = (0,0,0,0)
        [HideInInspector] _FresnelScale_Value1 ("", Vector) = (0,0,0,0)
        [HideInInspector] _FresnelScale_Value2 ("", Vector) = (0,0,0,0)
        [HideInInspector] _FresnelScale_LerpParam ("", Vector) = (0,0,0,0)
        [Sub(Fresnel)] [HDR] _FresnelColor ("Fresnel Color", Color) = (1,1,1,1)
        [HideInInspector] _FresnelColor_State ("", Vector) = (0,0,0,0)
        [HideInInspector] _FresnelColor_Value1 ("", Vector) = (0,0,0,0)
        [HideInInspector] _FresnelColor_Value2 ("", Vector) = (0,0,0,0)
        [HideInInspector] _FresnelColor_LerpParam ("", Vector) = (0,0,0,0)
        [SubToggle(Fresnel)] _FresnelColorAdditive ("Fresnel Color Additive Toggle", Float) = 0
        [SubToggle(Fresnel)] _FresnelInvert ("Fresnel Invert", Float) = 0
        [SubEnum(Fresnel,inAlpha, 0, fresnel, 1, Multiply, 2)] _FresnelAlpha ("Fresnel Alpha", Float) = 0
        [Header(Others)]
        ...
        [Header(Transparent Alpha Distance Fade)] _TransparentAlpha ("Transparent Alpha", Range(0, 1)) = 1
        [Toggle] _EnableTransAlphaDistFade ("Transparent Alpha Distance Enable", Float) = 0
        _TransparentAlphaDistanceMin ("Transparent Alpha Distance Min", Float) = 1
        _TransparentAlphaDistanceMax ("Transparent Alpha Distance Max", Float) = 5
        _TransparentAlphaDistanceAlphaMin ("Transparent Alpha Min", Range(0, 1)) = 0.6
        _TransparentAlphaDistanceAlphaMax ("Transparent Alpha Max", Range(0, 1)) = 0
        [Header(EyeTrans Distance Fade)] _EyeTransAlpha ("EyeTransparent Alpha", Range(0, 1)) = 0.5
        [Toggle] _EnableEyeTransDistFade ("Eye Transparent Distance Enable", Float) = 0
        _EyeTransDistanceMin ("Eye Transparent Distance Min", Float) = 1
        _EyeTransDistanceMax ("Eye Transparent Distance Max", Float) = 5
        _EyeTransDistanceAlphaMin ("Eye Transparent Alpha Min", Range(0, 1)) = 0.6
        _EyeTransDistanceAlphaMax ("Eye Transparent Alpha Max", Range(0, 1)) = 0
        [Header(Camera Direction Fade)] [Toggle] _EnableCameraDirFade ("CameraDirFade Enable", Float) = 0
        _CameraDirFadeHorizontalMin ("CameraDirFade Horizontal Min", Range(-1, 1)) = 0
        _CameraDirFadeHorizontalMax ("CameraDirFade Horizontal Max", Range(-1, 1)) = 1
        _CameraDirFadeAlphaMin ("CameraDirFade Alpha Min", Range(0, 1)) = 0
        _CameraDirFadeAlphaMax ("CameraDirFade Alpha Max", Range(0, 1)) = 1
...
[HideInInspector] _IsYup ("_IsYUp", Float) = 0
    ...
    SubShader
    {
        ...
        Pass
        {
            ...
            #pragma shader_feature_local ENABLE_FRESNEL_ON
