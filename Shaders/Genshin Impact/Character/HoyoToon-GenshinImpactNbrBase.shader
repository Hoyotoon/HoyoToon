Shader "HoyoToon/Genshin Impact/Character/NbrBase"
{
    Properties
    {
        ...
        [Main(CharacterNbrBase, ENABLE_CHARACTER_NBRBASE_ON, off, on)] _UseCharacterNbrBase ("CharacterNbrBase", Float) = 0
        [Sub(CharacterNbrBase)]  _NbrBaseColor ("NbrBaseColor", Color) = (0,0,0,1)
        [Sub(CharacterNbrBase)] _NbrRoughness ("NbrRoughness", Range(0, 1)) = 0.5
        [Sub(CharacterNbrBase)] _NbrScale ("NbrScale", Range(0, 1)) = 0.5
        [Sub(CharacterNbrBase)] _NbrRefTex ("NbrRefTex", 2D) = "black" { }
        [Sub(CharacterNbrBase)] _NbrRefScale ("NbrRefScale", Range(0, 1)) = 0
        [Sub(CharacterNbrBase)] _NbrRefTiling ("NbrRefTiling", Range(0, 5)) = 1
        [Sub(CharacterNbrBase)] _NbrRefBlur ("NbrRefBlur", Range(0, 1)) = 0.5
        [SubToggle(CharacterNbrBase)] _NbrBaseAOByLightmapG ("Use Lightmap.g For NbrBase AO", Float) = 0
    ...
    SubShader
    {
        ...
        Pass
        {
            ...
            #pragma shader_feature_local ENABLE_CHARACTER_NBRBASE_ON
