Shader "HoyoToon/Genshin Impact/Character/SkirkStar"
{
    Properties
    {
        ...
        [Main(Character Skirk Star, ENABLE_CHARACTER_SKIRK_STAR_ON)] _EnableCharacterSkirkStar ("Character Skirk Star", Float) = 0
        [Sub(Character Skirk Star)] _StarEmissionStrength ("Star Emission Strength", Range(0, 1)) = 1
        [Sub(Character Skirk Star)] [NoScaleOffset] _StarTex ("Star Tex", 2D) = "black" { }
        [HideInInspector] _StarTex_SamplerType ("", Float) = 0
        [Sub(Character Skirk Star)] _StarTexST ("Star Tex ST", Vector) = (1,1,0,0)
        [SubEnum(Character Skirk Star, R, 0, G, 1, B, 2, A, 3)] _StarTexChannelSwitch ("Star Tex Channel Switch", Float) = 2
        [Sub(Character Skirk Star)] _StarTexSpeed ("Star Tex Speed", Vector) = (0,0,0,0)
        [Sub(Character Skirk Star)] [HDR] _StarColor ("Star Color", Color) = (1,1,1,1)
        [SubMHYToggle(Character Skirk Star)] _StarFlickToggle ("Star Flick Toggle", Float) = 0
        [Sub(Character Skirk Star)] [HDR] _StarFlickColor ("Star Flick Color", Color) = (1,1,1,1)
        [Sub(Character Skirk Star)] _StarFlickRange ("Star Flick Range", Range(0, 0.2)) = 0.2
        [Sub(Character Skirk Star)] [NoScaleOffset] _BlockHighlightMask ("Block Highlight Mask", 2D) = "black" { }
        [HideInInspector] _BlockHighlightMask_SamplerType ("", Float) = 0
        [Sub(Character Skirk Star)] _BlockHighlightViewWeight ("Block Highlight View Weight", Float) = 0.5
        [Sub(Character Skirk Star)] _BlockHighlightRange ("Block Highlight Range", Float) = 0.9
        [Sub(Character Skirk Star)] _BlockHighlightSoftness ("Block Highlight Softness", Float) = 0
        [Sub(Character Skirk Star)] [HDR] _BlockHighlightColor ("Block Highlight Color", Color) = (1,1,1,1)
        [Sub(Character Skirk Star)] [NoScaleOffset] _StarMask ("Star Mask", 2D) = "white" { }
        [HideInInspector] _StarMask_SamplerType ("", Float) = 0
        [Sub(Character Skirk Star)] [NoScaleOffset] _BrightLineTex ("Bright Line Tex", 2D) = "black" { }
        [HideInInspector] _BrightLineTex_SamplerType ("", Float) = 0
        [SubEnum(Character Skirk Star, R, 0, G, 1, B, 2, A, 3)] _BrightLineTexChannelSwitch ("Bright Line Tex Channel Switch", Float) = 3
        [Sub(Character Skirk Star)] [NoScaleOffset] _BrightLineMask ("Bright Line Mask", 2D) = "white" { }
        [HideInInspector] _BrightLineMask_SamplerType ("", Float) = 0
        [SubEnum(Character Skirk Star, R, 0, G, 1, B, 2, A, 3)] _BrightLineMaskChannelSwitch ("Bright Line Mask Channel Switch", Float) = 3
        [Sub(Character Skirk Star)] _BrightLineMaskSpeed ("Bright Line Mask Speed", Vector) = (0,0,0,0)
        [Sub(Character Skirk Star)] [HDR] _BrightLineColor ("Bright Line Color", Color) = (1,1,1,1)
        [Sub(Character Skirk Star)] _BrightLineMaskContrast ("Bright Line Mask Contrast", Float) = 1
        ...
        [Main(HairTransparency,  HAIR_STENCIL_ON, off, on)] _dummyHairTransparent ("Stencils", Float) = 0
    ...
    SubShader
    {
        ...
        Pass
        {
            ...
            #pragma shader_feature_local ENABLE_CHARACTER_SKIRK_STAR_ON
