Shader "HoyoToon/Genshin Impact/Character/BaseUber_HairStencil"
{
    Properties
    {
    	...
    	[Header(Forward Eye Pass Through Stencil)] [IntRange] _StencilPassThroughRef ("Stencil Ref", Range(0, 255)) = 165
        [IntRange] _StencilPassThroughWriteMask ("Stencil Write Mask", Range(0, 255)) = 223  
        [IntRange] _StencilPassThroughReadMask ("Stencil Read Mask", Range(0, 255)) = 36
    	[Enum(UnityEngine.Rendering.CompareFunction)] _StencilPassComp ("Stencil Comp", Float) = 8
        [Enum(UnityEngine.Rendering.StencilOp)] _StencilPassOP ("Stencil Op", Float) = 2
    	
    	[Header(Forward Hair Transparency Stencil)] [IntRange] _StencilHairTransRef ("Stencil Ref", Range(0, 255)) = 165
        [IntRange] _StencilHairTransWriteMask ("Stencil Write Mask", Range(0, 255)) = 223  
        [IntRange] _StencilHairTransReadMask ("Stencil Read Mask", Range(0, 255)) = 36
    	[Enum(UnityEngine.Rendering.CompareFunction)] _StencilMaskComp ("Stencil Comp", Float) = 8
        [Enum(UnityEngine.Rendering.StencilOp)] _StencilMaskOP ("Stencil Op", Float) = 2
    	
    	[Header(Forward Hair Shadow Mask Stencil)] [IntRange] _StencilShadowMaskRef ("Stencil Ref", Range(0, 255)) = 133
        [IntRange] _StencilShadowMaskWriteMask ("Stencil Write Mask", Range(0, 255)) = 32  
        [IntRange] _StencilShadowMaskReadMask ("Stencil Read Mask", Range(0, 255)) = 36
    	[Enum(UnityEngine.Rendering.CompareFunction)] _StencilOutlineComp ("Stencil Comp", Float) = 8
        [Enum(UnityEngine.Rendering.StencilOp)] _StencilOutlineOP ("Stencil Op", Float) = 2
...
[HideInInspector] _IsYup ("_IsYUp", Float) = 0
    ...
    SubShader
    {
       ...
       ENDHLSL
		...
		Pass
        {
            Name "Forward Pass Through Pass"    
            Cull [_CullMode]
            Blend One Zero
            ...
            Stencil
            {
                Ref [_StencilPassThroughRef]
                ReadMask [_StencilPassThroughReadMask]
                WriteMask [_StencilPassThroughWriteMask]
                Comp [_StencilPassComp]
                Pass [_StencilPassOP]
            }
            HLSLPROGRAM
...
//
		Pass
        {
            Name "Forward Transparency Pass"    
            Cull [_CullMode]
            ...
            Stencil
            {
                Ref [_StencilHairTransRef]
                ReadMask [_StencilHairTransReadMask]
                WriteMask [_StencilHairTransWriteMask]
                Comp [_StencilMaskComp]
                Pass [_StencilMaskOP]
            }
            HLSLPROGRAM
            ...
            #pragma multi_compile_fwdbase
            #include "includes/GenshinImpact-base_program.hlsl"
            #define hair_transparency
            #pragma target 4.6
            #pragma vertex vert
            #pragma hull hull
            #pragma domain domain_base
            #pragma fragment hair_transparency_pixel
        ...
        Pass
        {
            Name "Outline Pass"    
            Cull Front
            Offset [_OutlinePolygonOffsetFactor], [_OutlinePolygonOffsetUnit]

            Stencil
            {
                Ref [_StencilOutlineRef]
                ReadMask [_StencilOutlineReadMask]
                WriteMask [_StencilOutlineWriteMask]
                Comp [_StencilOutlineComp]
                Pass [_StencilOutlineOP]
            }
            HLSLPROGRAM
            // #define ENABLE_OUTLINE_ON
