Shader "HoyoToon/Genshin Impact/Character/NyxState"
{
    Properties
    {
        ...
        [Main(CharacterLeather, ENABLE_CHARACTER_LEATHER_ON)] _UseCharacterLeather ("CharacterLeather", Float) = 0
        [Sub(CharacterLeather)] _LeatherSpecularColor ("Leather Specular Color", Color) = (1,1,1,1)
        [Sub(CharacterLeather)] _LeatherSpecularShift ("Leather Specualr Shift", Range(-1, 1)) = -0.5
        [Sub(CharacterLeather)] _LeatherSpecularRange ("Leather Specualr Range", Range(1, 200)) = 50
        [Sub(CharacterLeather)] _LeatherSpecularScale ("Leather Specualr Scale", Range(0, 1)) = 0
        [Sub(CharacterLeather)] _LeatherSpecularSharpe ("Leather Specualr Sharpe", Range(0.501, 1)) = 1
        [Sub(CharacterLeather)] _LeatherSpecularDetailColor ("Leather DetailSpecular Color", Color) = (1,1,1,1)
        [Sub(CharacterLeather)] _LeatherSpecularDetailRange ("Leather DetailSpecular Range", Range(1, 200)) = 50
        [Sub(CharacterLeather)] _LeatherSpecularDetailScale ("Leather DetailSpecular Scale", Range(0, 1)) = 0
        [Sub(CharacterLeather)] _LeatherSpecularDetailSharpe ("Leather Specualr Sharpe", Range(0.501, 1)) = 1
        [Tex(CharacterLeather)] _LeatherLaserRamp ("Laser Ramp", 2D) = "grey" { }
        [Sub(CharacterLeather)] _LeatherLaserTiling ("Leather Laser Tiling", Range(1, 6)) = 1
        [Sub(CharacterLeather)] _LeatherLaserOffset ("Leather Laser Offset", Range(0, 2)) = 0
        [Sub(CharacterLeather)] _LeatherLaserScale ("Leather Laser Scale", Range(0, 1)) = 0.5
        [Sub(CharacterLeather)] _LeatherReflect ("Leather Reflect", 2D) = "black" { }
        [Sub(CharacterLeather)] _LeatherReflectScale ("Leather ReflectScale", Range(0, 1)) = 0.5
        [Sub(CharacterLeather)] _LeatherReflectOffset ("Leather ReflectOffset", Range(-1, 1)) = 0.5
        ...
        [Main(NyxMainSettings, ENABLE_NYX_MARKING_ON, off, on)] _MainSettingsGroup ("NightSoul Main Settings", Float) = 0
        _CurTimeOfDay24 ("Current Time Of Day 24", Range(0, 24)) = 12
        // [SubMHYPackedGradient(NyxMainSettings, _NyxStateColorRamp _NyxStateTimeOfDayRamp)] _NyxStateOutlineColorRamp ("Color Ramp (RGB)", 2D) = "gray" { }
        [Tex(NyxMainSettings)] _NyxStateOutlineColorRamp ("Color Ramp (RGB)", 2D) = "gray" { }
        [Sub(NyxMainSettings)] _NyxStateOutlineColorScale ("Color Scale", Float) = 1
        [Sub(NyxMainSettings)] _NyxStateOutlineColorOnBodyMultiplier ("OnBody Color Scale", Color) = (1,1,1,1)
        [Sub(NyxMainSettings)] [NoScaleOffset] _NyxStateOutlineNoise ("Color and VertAnim Noise (RG)", 2D) = "gray" { }
        [Sub(NyxMainSettings)] _NyxStateOutlineColorNoiseScale ("Color Noise Scale", Vector) = (2,2,0,0)
        [Sub(NyxMainSettings)] _NyxStateOutlineColorNoiseAnim ("Color Noise Anim", Vector) = (0.05,0.05,0,0)
        [Sub(NyxMainSettings)] _NyxStateOutlineColorNoiseTurbulence ("Color Noise Turbulence", Range(0, 1)) = 0.25
        [Sub(NyxMainSettings)] [NoScaleOffset] _TempNyxStatePaintMaskTex ("Paint Mask", 2D) = "black" { }
        [SubEnum(NyxMainSettings, R, 0, G, 1, B, 2, A, 3)] _TempNyxStatePaintMaskChannel ("Paint Mask Channel", Float) = 0
        [Sub(NyxMainSettings)] _NyxStateOutlineColorOnBodyOpacity ("Paint Mask Multiplier", Range(0, 1)) = 1
        [Main(NyxOutline, ENABLE_NYX_OUTLINE_ON, off, on)] _OutlineGroup ("NightSoul Outline", Float) = 0
        [Sub(NyxOutline)] _NyxStateOutlineWidthScale ("Width Scale", Float) = 5
        [Sub(NyxOutline)] _NyxStateOutlineWidthVarietyWithResolution ("Variety with Resolution", Vector) = (1080,0,0,0)
        [SubToggle(NyxOutline)] _NyxStateEnableOutlineWidthScaleHeightLerp ("Enable Width Scale Height Lerp", Float) = 0
        [Sub(NyxOutline)] _NyxStateOutlineWidthScaleRange ("Width Scale Lerp Range", Vector) = (1,1,0,0)
        [Sub(NyxOutline)] _NyxStateOutlineWidthScaleLerpHeightRange ("Lerp Height Range", Vector) = (0,1,1,0)
        [Sub(NyxOutline)] _NyxStateOutlineVertAnimNoiseScale ("VertAnim Noise Scale", Vector) = (2,2,0,0)
        [Sub(NyxOutline)] _NyxStateOutlineVertAnimNoiseAnim ("VertAnim Noise Anim", Vector) = (0.05,0.05,0,0)
        [Sub(NyxOutline)] _NyxStateOutlineVertAnimScale ("VertAnim Scale", Float) = 30
        [SubToggle(NyxOutline)] _NyxStateEnableOutlineVertAnimScaleHeightLerp ("Enable VertAnim Scale Height Lerp", Float) = 0
        [Sub(NyxOutline)] _NyxStateOutlineVertAnimScaleRange ("VertAnim Scale Lerp Range", Vector) = (1,1,0,0)
        [Sub(NyxOutline)] _NyxStateOutlineVertAnimScaleLerpHeightRange ("Lerp Height Range", Vector) = (0,1,1,0)
    ...
    SubShader
    {
        ...
        Pass
        {
            ...
            #pragma shader_feature_local ENABLE_NYX_OUTLINE_ON
            #pragma shader_feature_local ENABLE_CHARACTER_LEATHER_ON 
